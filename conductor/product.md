...
# Key Goals
1.  **RavenDB Identity Provider**: Develop a robust ASP.NET Core Identity implementation in `Aero.Identity`, supporting standard authentication, external providers, and modern FIDO2/WebAuthn passkeys.
