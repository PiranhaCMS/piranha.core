...
# Key Goals
1.  **RavenDB Identity Provider**: Develop a robust ASP.NET Core Identity implementation in `Aero.Identity`, supporting both standard authentication and external providers.
...
# Core Requirements
- **Standardized Identity**: Support for User, Role, and External Provider authentication via RavenDB.
