...
namespace Piranha.Repositories
{
    public interface ITagRepository
    {
        ...
        Task<IEnumerable<Tag>> GetAll(Guid blogId);
        ...
        Task<IEnumerable<Tag>> GetByPostId(Guid postId);
        ...
        /// <returns>The model</returns>
        Task<Tag> GetBySlug(Guid blogId, string slug);
        ...
        /// <returns>The model</returns>
        Task<Tag> GetByTitle(Guid blogId, string title);
