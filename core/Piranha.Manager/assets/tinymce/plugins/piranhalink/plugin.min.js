...
tinymce.PluginManager.add('piranhalink', function (editor) {
    function showDialog() {
        ...
        text = linkElm.nodeName == "A" && !linkElm.getAttribute('data-mce-object') ? linkElm.innerHTML : editor.selection.getContent({ format: 'text' });
        ...
        win = editor.windowManager.open({
            ...
            body: [
				...
				{ name: 'text', type: 'textbox', label: 'Text to display' },
                {
                    name: 'target', 
                    type: 'listbox', 
                    label: 'Target', 
            ...
            onSubmit: function (e) {
                ...
                if (linkElm) {
                    ...
                    editor.insertContent(dom.createHTML('a', data, data.text));
                }
            }
        });
    }
