...
piranha.editor = {
    ...
    addInline: function (id) {
        tinymce.init({
            ...
            convert_urls: false,
            plugins: [
                "autoresize autolink code hr paste lists piranhalink" // TODO: piranhaimage
            ],
            width: "100%",
            autoresize_min_height: 0,
            toolbar: "bold italic | bullist numlist hr | alignleft aligncenter alignright | formatselect | piranhalink", // TODO: | piranhalink piranhaimage",
