function RegisterMarkdown(n){var i=$(n).parent().parent().find(".content-preview"),t=new SimpleMDE({element:n,status:!1,spellChecker:!1,hideIcons:["preview","guide"],toolbar:["bold","italic","heading","|","quote","unordered-list","ordered-list","|","link",{name:"image",action:function(n){piranha.media.initCallback=function(){piranha.media.mediaFilter="image"};$("#modalMedia").modal("show");piranha.media.callback=function(i){var r=n.codemirror,f=t.getState(r).image,u=r.getCursor("start"),e=r.getCursor("end");f?(text=r.getLine(u.line),r.replaceRange("!["+i.name+"]("+i.url+")",{line:u.line,ch:0})):r.replaceSelection("!["+i.name+"]("+i.url+")");r.setSelection(u,e);r.focus()}},className:"fa fa-picture-o",title:"Image"},"side-by-side","fullscreen"],renderingConfig:{singleLineBreaks:!1}});mdeEditors[$(n).attr("id")]=t;t.codemirror.on("change",function(){i.html(t.markdown(t.value()))})}var sortable,mdeEditors,sortableBlocks,sortableRegions,n,manager;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector),function(n){n.forEach(function(n){n.hasOwnProperty("remove")||Object.defineProperty(n,"remove",{configurable:!0,enumerable:!0,writable:!0,value:function(){this.parentNode!==null&&this.parentNode.removeChild(this)}})})}([Element.prototype,CharacterData.prototype,DocumentType.prototype]);Object.entries||(Object.entries=function(n){for(var i=Object.keys(n),t=i.length,r=new Array(t);t--;)r[t]=[i[t],n[i[t]]];return r});Array.prototype.includes||Object.defineProperty(Array.prototype,"includes",{value:function(n,t){function e(n,t){return n===t||typeof n=="number"&&typeof t=="number"&&isNaN(n)&&isNaN(t)}var f,i,r,u;if(this==null)throw new TypeError('"this" is null or not defined');if(f=Object(this),i=f.length>>>0,i===0)return!1;for(r=t|0,u=Math.max(r>=0?r:i-Math.abs(r),0);u<i;){if(e(f[u],n))return!0;u++}return!1}});
/*!
