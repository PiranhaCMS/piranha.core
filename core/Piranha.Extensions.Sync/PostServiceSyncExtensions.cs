...
namespace Piranha.Services
{
    public static class PostServiceSyncExtensions
    {
        ...
        public static IEnumerable<DynamicPost> GetAll(this PostService service, Guid blogId)
        {
        ...
        /// <returns>The posts</returns>
        public static IEnumerable<T> GetAll<T>(this PostService service, Guid blogId) where T : PostBase
        {
        ...
        /// <returns>The posts</returns>
        public static IEnumerable<DynamicPost> GetAllBySiteId(this PostService service, Guid? siteId = null)
        {
        ...
        /// <param name="siteId">The optional site id</param>
        /// <returns>The posts</returns>
        public static IEnumerable<T> GetAllBySiteId<T>(this PostService service, Guid? siteId = null) where T : PostBase
        {
        ...
        /// <param name="siteId">The optional site id</param>
        /// <returns>The posts</returns>
        public static IEnumerable<DynamicPost> GetAll(this PostService service, string slug, Guid? siteId = null)
        {
        ...
        /// <param name="siteId">The optional site id</param>
        /// <returns>The posts</returns>
        public static IEnumerable<T> GetAll<T>(this PostService service, string slug, Guid? siteId = null) where T : PostBase
        {
        ...
        public static IEnumerable<Taxonomy> GetAllCategories(this PostService service, Guid blogId)
        {
        ...
        public static IEnumerable<Taxonomy> GetAllTags(this PostService service, Guid blogId)
        {
        ...
        /// <param name="id">The unique id</param>
        /// <returns>The post model</returns>
        public static T GetById<T>(this PostService service, Guid id) where T : PostBase
        {
        ...
        /// <param name="siteId">The optional site id</param>
        /// <returns>The post model</returns>
        public static T GetBySlug<T>(this PostService service, string blog, string slug, Guid? siteId = null) where T : PostBase
        {
        ...
        /// <param name="slug">The unique slug</param>
        /// <returns>The post model</returns>
        public static T GetBySlug<T>(this PostService service, Guid blogId, string slug) where T : PostBase
        {
        ...
        public static void Save<T>(this PostService service, T model) where T : PostBase
        {
        ...
        public static void Delete<T>(this PostService service, T model) where T : PostBase
        {
