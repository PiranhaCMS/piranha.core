...
namespace Piranha.Services
{
    public static class MediaServiceSyncExtensions
    {
        ...
        public static IEnumerable<Media> GetAll(this MediaService service, Guid? folderId = null)
        {
        ...
        public static IEnumerable<MediaFolder> GetAllFolders(this MediaService service, Guid? folderId = null)
        {
