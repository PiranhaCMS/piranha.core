NAMESPACE=control
SECRET_NAME="notifications-env-secret"
ENV_FILE_PATH="infrastructure/secrets/.env.notifications"
DOCKER_IMAGE="k3d-registry:5000/contentrus-notificationservice"
