...
namespace Piranha.Data.EF.SQLite.Migrations
{
    ...
    [Migration("20260713120000_AddPagePostTranslations")]
    partial class AddPagePostTranslations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piranha.Data.PageBlockFieldTranslation", b =>
                {
                    b.Property<Guid>("FieldId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_PageBlockFieldTranslations");
                });
            ...
            modelBuilder.Entity("Piranha.Data.PageFieldTranslation", b =>
                {
                    b.Property<Guid>("FieldId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_PageFieldTranslations");
                });
            ...
            modelBuilder.Entity("Piranha.Data.PageTranslation", b =>
                {
                    b.Property<Guid>("PageId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_PageTranslations");
                });
            ...
            modelBuilder.Entity("Piranha.Data.PostFieldTranslation", b =>
                {
                    b.Property<Guid>("FieldId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_PostFieldTranslations");
                });
            ...
            modelBuilder.Entity("Piranha.Data.PostTranslation", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Piranha_PostTranslations");
                });
            ...
            modelBuilder.Entity("Piranha.Data.PageFieldTranslation", b =>
                {
                    b.HasOne("Piranha.Data.PageField", "Field")
                        .WithMany("Translations")
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Piranha.Data.PageBlockFieldTranslation", b =>
                {
                    b.HasOne("Piranha.Data.BlockField", "Field")
                        .WithMany("Translations")
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Piranha.Data.PostFieldTranslation", b =>
                {
                    b.HasOne("Piranha.Data.PostField", "Field")
                        .WithMany("Translations")
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
