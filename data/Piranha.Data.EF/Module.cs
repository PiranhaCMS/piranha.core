...
/// <summary>
/// AutoMapper profile for Piranha data mappings.
/// </summary>
public class PiranhaDataProfile : Profile
{
    public PiranhaDataProfile()
    {
        CreateMap<Data.Alias, Data.Alias>()
            .ForMember(a => a.Id, o => o.Ignore())
            .ForMember(a => a.Created, o => o.Ignore());
        CreateMap<Data.Category, Data.Category>()
            .ForMember(c => c.Id, o => o.Ignore())
            .ForMember(c => c.Created, o => o.Ignore());
        CreateMap<Data.Category, Models.Taxonomy>()
            .ForMember(c => c.Type, o => o.MapFrom(m => Models.TaxonomyType.Category));
        CreateMap<Data.Content, Models.GenericContent>()
            .ForMember(p => p.PrimaryImage, o => o.MapFrom(m => m.PrimaryImageId))
            .ForMember(p => p.Permissions, o => o.Ignore());
        CreateMap<Models.GenericContent, Data.Content>()
        ...
        CreateMap<Data.ContentGroup, Models.ContentGroup>();
        CreateMap<Models.ContentGroup, Data.ContentGroup>()
            .ForMember(g => g.Created, o => o.Ignore())
            .ForMember(g => g.LastModified, o => o.Ignore());
        CreateMap<Data.ContentTranslation, Models.GenericContent>()
            .ForMember(c =>  c.Id, o => o.Ignore())
        ...
        CreateMap<Data.MediaFolder, Data.MediaFolder>()
            .ForMember(f => f.Id, o => o.Ignore())
            .ForMember(f => f.Created, o => o.Ignore())
            .ForMember(f => f.Media, o => o.Ignore());
        CreateMap<Data.MediaFolder, Models.MediaStructureItem>()
        ...
        CreateMap<Data.Page, Models.PageBase>()
        ...
        CreateMap<Models.PageBase, Data.Page>()
        ...
        CreateMap<Data.Page, Models.SitemapItem>()
        ...
        CreateMap<Data.Param, Data.Param>()
            .ForMember(p => p.Id, o => o.Ignore())
            .ForMember(p => p.Created, o => o.Ignore());
        CreateMap<Data.Post, Models.PostBase>()
            ...
            .ForMember(p => p.Blocks, o => o.Ignore())
            .ForMember(p => p.CommentCount, o => o.Ignore());
        CreateMap<Data.PostTag, Models.Taxonomy>()
        ...
        CreateMap<Models.PostBase, Data.Post>()
        ...
        CreateMap<Data.Tag, Data.Tag>()
            .ForMember(t => t.Id, o => o.Ignore())
            .ForMember(t => t.Created, o => o.Ignore());
        CreateMap<Data.Tag, Models.Taxonomy>()
...
public class Module : IModule
{
    ...
    static Module()
    {
        // AutoMapper 14 should support standard lambda configuration
        var config = new MapperConfiguration(cfg =>
        {
            cfg.AddProfile<PiranhaDataProfile>();
        });
