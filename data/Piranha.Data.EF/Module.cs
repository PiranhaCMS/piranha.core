    ...
    static Module()
    {
        var mapperConfig = new MapperConfiguration(cfg =>
        {
            ...
            cfg.CreateMap<Models.PageBase, Data.Page>()
                ...
                .ForMember(p => p.Translations, o => o.Ignore())
            ...
            cfg.CreateMap<Data.PageTranslation, Models.PageBase>()
                .ForMember(p => p.Id, o => o.Ignore())
                .ForMember(p => p.TypeId, o => o.Ignore())
                .ForMember(p => p.PrimaryImage, o => o.Ignore())
                .ForMember(p => p.OgImage, o => o.Ignore())
                .ForMember(p => p.Permalink, o => o.MapFrom(m => "/" + m.Slug))
                .ForMember(p => p.Permissions, o => o.Ignore())
                .ForMember(p => p.Blocks, o => o.Ignore())
                .ForMember(p => p.CommentCount, o => o.Ignore())
                .ForMember(p => p.SiteId, o => o.Ignore())
                .ForMember(p => p.ParentId, o => o.Ignore())
                .ForMember(p => p.OriginalPageId, o => o.Ignore())
                .ForMember(p => p.SortOrder, o => o.Ignore())
                .ForMember(p => p.Published, o => o.Ignore())
                .ForMember(p => p.Created, o => o.Ignore())
                .ForMember(p => p.LastModified, o => o.Ignore())
                .ForMember(p => p.IsHidden, o => o.Ignore())
                .ForMember(p => p.Route, o => o.Ignore())
                .ForMember(p => p.RedirectUrl, o => o.Ignore())
                .ForMember(p => p.RedirectType, o => o.Ignore())
                .ForMember(p => p.EnableComments, o => o.Ignore())
                .ForMember(p => p.CloseCommentsAfterDays, o => o.Ignore())
                .ForMember(p => p.MetaIndex, o => o.Ignore())
                .ForMember(p => p.MetaFollow, o => o.Ignore())
                .ForMember(p => p.MetaPriority, o => o.Ignore());
