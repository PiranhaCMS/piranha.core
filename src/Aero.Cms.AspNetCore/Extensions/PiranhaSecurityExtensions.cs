...
using Aero.Cms.AspNetCore.Security;
...
/// </summary>
public static class AeroSecurityExtensions
{
    /// <summary>
    ...
    public static AeroServiceBuilder UseSecurity(this AeroServiceBuilder builder,
