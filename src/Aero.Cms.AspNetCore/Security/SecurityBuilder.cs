...
public class SecurityBuilder
{
    ...
    private readonly AeroServiceBuilder _builder;
    ...
    public SecurityBuilder(AuthorizationOptions authorization, AeroServiceBuilder builder)
    {
    ...
    public SecurityBuilder UsePermission(string name, string title = null)
    {
        ...
        _authorization.AddPolicy(name, policy =>
        {
            ...
            App.Permissions["App"].Add(new Aero.Cms.Security.PermissionItem
            {
