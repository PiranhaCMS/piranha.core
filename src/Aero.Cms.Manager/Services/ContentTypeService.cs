...
public class ContentTypeService
{
    ...
    public BlockListModel GetBlockTypes(string parentType = null)
    {
        ...
        var exludeGroups = parent != null && typeof(Aero.Cms.Extend.BlockGroup).IsAssignableFrom(parent.Type);
        ...
        foreach (var category in App.Blocks.GetCategories().OrderBy(c => c))
        {
            ...
            if (parent != null)
            {
                ...
                if (exludeGroups)
                {
                    items = items.Where(i => !typeof(Aero.Cms.Extend.BlockGroup).IsAssignableFrom(i.Type)).ToList();
                }
            }
