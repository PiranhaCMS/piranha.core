...
public static class Actions
{
    ...
    public sealed class ToolbarActions
    {
        ...
        public ActionList<ToolbarAction> ContentEdit { get; private set; } = new ActionList<ToolbarAction>
        {
            ...
            {
                InternalId = "Settings",
                ActionView = "Partial/Actions/_ContentSettingsAction"
            },
            new ToolbarAction
            {
                InternalId = "Save",
        ...
        public ActionList<ToolbarAction> PageEdit { get; private set; } = new ActionList<ToolbarAction>
        {
            ...
            {
                InternalId = "Settings",
                ActionView = "Partial/Actions/_PageSettingsAction"
            },
            new ToolbarAction
            {
                InternalId = "Preview",
        ...
        public ActionList<ToolbarAction> PostEdit { get; private set; } = new ActionList<ToolbarAction>
        {
            ...
            {
                InternalId = "Settings",
                ActionView = "Partial/Actions/_PostSettingsAction"
            },
            new ToolbarAction
            {
                InternalId = "Preview",
