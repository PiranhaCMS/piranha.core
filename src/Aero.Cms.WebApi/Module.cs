...
public sealed class Module : Extend.IModule
{
    ...
    /// Gets the Name
    /// </summary>
    public string Name => "Aero.Cms.WebApi";
    ...
    /// </summary>
    public string Description => "Web Api module for Aero.Cms.";

    /// <summary>
    /// Gets the package url.
    /// </summary>
    public string PackageUrl => "https://www.nuget.org/packages/Aero.Cms.WebApi";
