...
//
// http://github.com/Aerocms/Aero.core
//

tinymce.PluginManager.add('Aerolink', function (editor) {
    function showDialog() {
        ...
        var editorOptions = {
            ...
            onAction: function (e, sender) {
                if (sender.name === 'pagedialog') {
                    Aero.pagepicker.open(function (data) {
                        win.setData({ href: data.permalink });
                    });
                } else if (sender.name == 'postdialog') {
                    Aero.postpicker.open(function (data) {
                        win.setData({ href: data.permalink });
                    });
        ...
        Aero.win = win = editor.windowManager.open(editorOptions);
    }
    ...
    editor.ui.registry.addToggleButton('Aerolink', {
        icon: 'link',
