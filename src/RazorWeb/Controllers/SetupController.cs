...
public class SetupController : Controller
{
    ...
    public async Task<IActionResult> Seed()
    {
        ...
        foreach (var image in Directory.GetFiles("seed"))
        {
            ...
            {
                await _api.Media.SaveAsync(new Aero.Cms.Models.StreamMediaContent()
                {
                    Id = id,
                    Filename = info.Name,
                    Data = stream
        ...
        docsPage.RedirectUrl = "https://Aerocms.org/docs";
        ...
        docsPage.Excerpt = "Ready to get started! Then head over to our official documentation and learn more about Aero.Cms and how to use it.";
        ...
        post3.Blocks.Add(new ColumnBlock
        {
            Items = new List<Block>
            {
                new MarkdownBlock
                {
                    Body =
                        "#### Core\n\n" +
                        "* Remove the need to use MARS for SQL Server [#1417](https://github.com/Aerocms/Aero.core/issues/1417)\n" +
                        "* Detect EXIF orientation on mobile pictures [#1442](https://github.com/Aerocms/Aero.core/issues/1442)\n" +
                        "* Update BlobStorage to use Azure.Storage.Blobs [#1564](https://github.com/Aerocms/Aero.core/pull/1564)\n" +
                        "* Update Pomelo.EntityFrameworkCore.MySql [#1646](https://github.com/Aerocms/Aero.core/pull/1646)\n" +
                        "* Add sort order to fields [#1732](https://github.com/Aerocms/Aero.core/issues/1732)\n" +
                        "* Update to .NET 6 [#1733](https://github.com/Aerocms/Aero.core/issues/1733)\n" +
                        "* Use Identify to get image width and height [#1734](https://github.com/Aerocms/Aero.core/pull/1734)\n" +
                        "* Clean up application startup [#1738](https://github.com/Aerocms/Aero.core/issues/1738)\n" +
                        "* Add markdown block [#1744](https://github.com/Aerocms/Aero.core/issues/1744)\n" +
                        "* Remove description attributes [#1747](https://github.com/Aerocms/Aero.core/issues/1747)\n\n" +
                        "#### Manager\n\n" +
                        "* Add content settings (with region support) [#1524](https://github.com/Aerocms/Aero.core/issues/1524)\n" +
                        "* Update Summernote package [#1730](https://github.com/Aerocms/Aero.core/issues/1730)\n" +
                        "* Manager security update [#1741](https://github.com/Aerocms/Aero.core/issues/1741)\n" +
                        "* Redesign Add page button in manager [#1748](https://github.com/Aerocms/Aero.core/issues/1748)\n\n" +
                        "#### Bugfixes\n\n" +
                        "* Cannot access disposed object [#1701](https://github.com/Aerocms/Aero.core/issues/1701)\n" +
                        "* Invalid PageField URL in Manager [#1705](https://github.com/Aerocms/Aero.core/issues/1705)\n"
                },
                new ImageBlock
                {
        ...
        var comment = new Aero.Cms.Models.PostComment
        {
            Author = "Håkan Edling",
            Email = "hakan@tidyui.com",
            Url = "http://Aerocms.org",
